...
void PopupList::renderOpenGlComponents(OpenGlWrapper& open_gl, bool animate) {
  ...
  float image_width = electrosynth::utils::nextPowerOfTwo(getWidth());
  float image_height = electrosynth::utils::nextPowerOfTwo(rows_->getImageHeight());
...
//
//  float image_width = electrosynth::utils::nextPowerOfTwo(getWidth());
//  float image_height = electrosynth::utils::nextPowerOfTwo(row_height);
//  float width_ratio = image_width / getWidth();
