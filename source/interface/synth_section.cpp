...
void SynthSection::paintSidewaysHeadingText(Graphics& g) {
  ...
  g.addTransform(AffineTransform::rotation(-electrosynth::kPi / 2.0f));
...
//  electrosynth::ValueDetails hz_details = *slider->getDisplayDetails();
//  hz_details.value_scale = electrosynth::ValueDetails::kExponential;
//  hz_details.post_offset = 0.0f;
//  hz_details.display_units = " Hz";
//  hz_details.display_multiply = electrosynth::kMidi0Frequency;
