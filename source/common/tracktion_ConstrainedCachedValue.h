...
#ifndef ELECTROSYNTH2_TRACKTION_CONSTRAINEDCACHEDVALUE_H
#define ELECTROSYNTH2_TRACKTION_CONSTRAINEDCACHEDVALUE_H
/*
    ,--.                     ,--.     ,--.  ,--.
  ,-'  '-.,--.--.,--,--.,---.|  |,-.,-'  '-.`--' ,---. ,--,--,      Copyright 2018
  '-.  .-'|  .--' ,-.  | .--'|     /'-.  .-',--.| .-. ||      \   Tracktion Software
...
#endif //ELECTROSYNTH2_TRACKTION_CONSTRAINEDCACHEDVALUE_H
